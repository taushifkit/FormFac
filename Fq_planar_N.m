...
A3 -> (16*Cf*Ca^2*(245/24-67/9*zeta2+11/6*zeta3+11/5*zeta2^2)
      ...
      +16*Cf*nf^2*(-1/27) ),
A4 -> (N/2 ( (-32 Pi^4/135 + 1280 Zeta[3]/27 - 304 Pi^2/243 + 2119/81) N nf^2
         + (128 Pi^2 Zeta[3]/9 + 224 Zeta[5] - 44 Pi^4/27 - 16252 Zeta[3]/27 + 13346 Pi^2/243 - 39883/81) N^2 nf
         + (64 Zeta[3]/27 - 32/81) nf^3 
      + (-32 Zeta[3]^2 - 176/9 Pi^2 Zeta[3] + 20992/27 Zeta[3] - 352 Zeta[5] - 292/315 Pi^6
         + 902/45 Pi^4 - 44416 Pi^2/243 + 84278/81) N^3 )),
...
(* The nf-dependent part in large-N limit of the Un is extracted from 1604.03126 Eq.(2.7)   *)
(* The nf-INdependent part in large-N limit of the Un is extracted from 1612.04389 Eq.(12)  *)
...
G10 -> (3*N),
G11 -> ( N*(8 - Pi^2/6) ),
G12 -> ( N*(16 - Pi^2/4 - (14*Zeta[3])/3) ),
G13 -> ( N*(32 - (2*Pi^2)/3 - (47*Pi^4)/720 - 7*Zeta[3]) ),
G14 -> ( N*(64 - 8*zeta2 - (141*zeta2^2)/40 - (56*zeta3)/3 + (7*zeta2*zeta3)/3 - 
	  (62*zeta5)/5) ),
G15 -> ( N*(128 - 16*zeta2 - (47*zeta2^2)/5 - (949*zeta2^3)/280 - (112*zeta3)/3 +
	  (7*zeta2*zeta3)/2 + (49*zeta3^2)/9 - (93*zeta5)/5) ),
G16 -> ( N*(256 - 32*zeta2 - (94*zeta2^2)/5 - (2847*zeta2^3)/560 - (224*zeta3)/3 +
	  (28*zeta2*zeta3)/3 + (329*zeta2^2*zeta3)/60 + (49*zeta3^2)/6 -
	  (248*zeta5)/5 + (31*zeta2*zeta5)/5 - (254*zeta7)/7) ),
G17 -> ( N*(512 - 64*zeta2 - (188*zeta2^2)/5 - (949*zeta2^3)/70 - 
...
G20 -> ( N*nl*(-209/27 - (2*Pi^2)/9) + N^2*(5171/108 + (2*Pi^2)/9 - 14*Zeta[3]) ),
G21 -> ( N^2*(140411/648 + (53*Pi^2)/108 - (11*Pi^4)/45 - (170*Zeta[3])/3) + 
	 N*nl*(-5813/162 - (37*Pi^2)/54 + (8*Zeta[3])/3) ),
G22 -> ( N*nl*(-129389/972 - (425*Pi^2)/162 + (7*Pi^4)/216 + (602*Zeta[3])/27) + 
 	N^2*(3069107/3888 + (2795*Pi^2)/648 - (1969*Pi^4)/2160 - (7511*Zeta[3])/27 + 
   	(47*Pi^2*Zeta[3])/9 - 90*Zeta[5]) ),
G23 -> ( N^2*(61411595/23328 + (69131*zeta2)/648 - (55187*zeta2^2)/360 - 
	   (907*zeta2^3)/35 - (162443*zeta3)/162 + (161*zeta2*zeta3)/3 + 
	   (334*zeta3^2)/3 - 402*zeta5) + N*nl*(-2628821/5832 - (8405*zeta2)/162 + 
	   (1873*zeta2^2)/180 + (8170*zeta3)/81 + (22*zeta2*zeta3)/3 + 24*zeta5) ),
G24 -> ( N*nl*(-50947325/34992 - (160493*zeta2)/972 + (12781*zeta2^2)/270 +
	   (953*zeta2^3)/60 + (91985*zeta3)/243 + (791*zeta2*zeta3)/27 -
	   (578*zeta3^2)/27 + (6218*zeta5)/45) +
	 N^2*(1175293667/139968 + (1506131*zeta2)/3888 - (579427*zeta2^2)/1080 -
...
G25 -> ( N^2*(21943277819/839808 + (30665291*zeta2)/23328 - (11254483*zeta2^2)/6480 - 
	 ...
	 N*nl*(-960894437/209952 - (3002069*zeta2)/5832 + (288877*zeta2^2)/1620 + 
...
G30 -> ( N*nl^2*(9838/729 + (76*Pi^2)/81 + (16*Zeta[3])/27) + 
	 N^2*nl*(-361489/1458 - (1933*Pi^2)/243 + (8*Pi^4)/45 + (416*Zeta[3])/9) + 
	 N^3*(4317713/5832 + (7165*Pi^2)/972 - (22*Pi^4)/45 - (10237*Zeta[3])/27 + 
	   (44*Pi^2*Zeta[3])/9 + 136*Zeta[5]) ),

G31 -> ( N*nl^2*(258445/2187 + (3466*zeta2)/81 + (40*zeta2^2)/9 - (536*zeta3)/81) + 
	 N^3*(197609041/34992 + (718195*zeta2)/972 - (13844*zeta2^2)/45 + 
 	  (5392*zeta2^3)/45 - (8816*zeta3)/3 + (1496*zeta2*zeta3)/9 + 
	   (656*zeta3^2)/3 - 224*zeta5) + 
	 N^2*nl*(-16790213/8748 - (416425*zeta2)/972 + (110*zeta2^2)/3 + 
	   (39110*zeta3)/81 - (164*zeta2*zeta3)/9 + (400*zeta5)/3) + 
	 N^2*(-12*nfv - 30*nfv*zeta2 + (6*nfv*zeta2^2)/5 - 14*nfv*zeta3 + 
	   80*nfv*zeta5) ),

G32 -> ( N*nl^2*(1024873/1458 + (58904*zeta2)/243 + (269*zeta2^2)/9 - 
	   (22220*zeta3)/243 - (376*zeta2*zeta3)/27 - (112*zeta5)/9) + 
	 N^2*nl*(-188719859/17496 - (3943345*zeta2)/1458 + (78947*zeta2^2)/540 + 
	   (3926*zeta2^3)/35 + (184573*zeta3)/54 + (68*zeta2*zeta3)/27 - 
	   152*zeta3^2 + 1376*zeta5) + N^2*(-170*nfv - 260*nfv*zeta2 + 
	   (196*nfv*zeta2^2)/5 + (9728*nfv*zeta2^3)/105 - (94*nfv*zeta3)/3 - 
	   90*nfv*zeta2*zeta3 + 344*nfv*zeta3^2 - (752*nfv*zeta5)/3) + 
	 N^3*(2200841219/69984 + (64740335*zeta2)/11664 - (949937*zeta2^2)/540 - 
...
G33 -> ( N*nl^2*(280473545/78732 + (861265*zeta2)/729 + (123979*zeta2^2)/810 - 
	   (127*zeta2^3)/135 - (156088*zeta3)/243 - (11344*zeta2*zeta3)/81 + 
	   (320*zeta3^2)/27 - (5368*zeta5)/27) + 
	 N^3*(191830138457/1259712 + (2240*multi5zeta3)/3 + 
	 ...
	 N^2*nl*(-16564962265/314928 - (124242523*zeta2)/8748 + 
	 ...
	 N^2*(-1460*nfv - (4345*nfv*zeta2)/3 + (3677*nfv*zeta2^2)/15 - 
...
G40 -> ( N^3*((197609041*bt0)/34992 + (718195*bt0*zeta2)/972 -
	   (13844*bt0*zeta2^2)/45 + (5392*bt0*zeta2^3)/45 - (8816*bt0*zeta3)/3 +
	   (1496*bt0*zeta2*zeta3)/9 + (656*bt0*zeta3^2)/3 - 224*bt0*zeta5) +
	 N*nl^3*(-18691/6561 + (4*Pi^2)/81 + (16*Pi^4)/1215 + (712*Zeta[3])/243) +
	 N*(32*bt0^3 - 32*bt0*bt1 + 8*bt2 - (2*bt0^3*Pi^2)/3 + (bt0*bt1*Pi^2)/2 -
	   (bt2*Pi^2)/6 - (47*bt0^3*Pi^4)/720 - 7*bt0^3*Zeta[3] +
	   (28*bt0*bt1*Zeta[3])/3) +
	 nl*(N^2*((-16790213*bt0)/8748 - (416425*bt0*zeta2)/972 +
     (110*bt0*zeta2^2)/3 + (39110*bt0*zeta3)/81 - (164*bt0*zeta2*zeta3)/9 +
     (400*bt0*zeta5)/3) + N*((129389*bt0^2)/972 - (5813*bt1)/162 +
     (425*bt0^2*Pi^2)/162 - (37*bt1*Pi^2)/54 - (7*bt0^2*Pi^4)/216 -
     (602*bt0^2*Zeta[3])/27 + (8*bt1*Zeta[3])/3) +
	   N^3*(-145651/864 - (354343*Pi^2)/8748 - (3557*Pi^4)/9720 +
     (1567*Pi^6)/10206 + (94807*Zeta[3])/486 - (166*Pi^2*Zeta[3])/9 +
     (1360*Zeta[3]^2)/9 - (1114*Zeta[5])/9)) +
	 nl^2*(N*((258445*bt0)/2187 + (3466*bt0*zeta2)/81 + (40*bt0*zeta2^2)/9 -
     (536*bt0*zeta3)/81) + N^2*(82181/34992 + (68201*Pi^2)/8748 -
     (331*Pi^4)/1215 + (4262*Zeta[3])/243 + (4*Pi^2*Zeta[3])/3 -
     (332*Zeta[5])/9)) + N^2*((-3069107*bt0^2)/3888 + (140411*bt1)/648 -
	 ...
	 N^4*(187905439/419904 + (120659*Pi^2)/8748 + (59509*Pi^4)/4860 -
...
G41 -> ( N*((-10739263*nf^3)/4374 - (290230*nf^3*Pi^2)/2187 - (3322*nf^3*Pi^4)/1215 + 
    ...
    (8776*nf^3*Zeta[5])/135) + N^2*((68487272627*nf^2)/1889568 + 
  ...
  N^4*(43551568175/279936 - (7952*HPLs8a)/9 + (8960*multi5zeta3)/9 + 
  ...
  N^3*((-555003607961*nf)/3779136 - (785989381*nf*Pi^2)/104976 + 
...
K1 -> (-N),
K2 -> ((-827*N^2)/108 + (5*N*nl)/27 - (3*N^2*Pi^2)/2 + (N*nl*Pi^2)/3 +
   18*N^2*Zeta[3]),
K3 -> ((-93823*N^3)/2916 - (859*N^2*nl)/2916 + (2201*N*nl^2)/729 -
   (14929*N^3*Pi^2)/972 + (2963*N^2*nl*Pi^2)/486 - (10*N*nl^2*Pi^2)/27 +
   (11*N^3*Pi^4)/135 - (2*N^2*nl*Pi^4)/135 + (949*N^3*Zeta[3])/3 -
   (1108*N^2*nl*Zeta[3])/27 - (8*N*nl^2*Zeta[3])/27 -
   (32*N^3*Pi^2*Zeta[3])/9 - 172*N^3*Zeta[5]),
...
C10 -> ( N*(2 + Pi^2/12) ),
C11 -> ( N*(4 + Pi^2/24 - Zeta[3]/3) ),
C12 -> ( N*(8 + Pi^2/6 + Pi^4/160 - Zeta[3]/6) ),
(*
C13 -> ( N*(16 + Pi^2/3 + Pi^4/320 - (2*Zeta[3])/3 - (Pi^2*Zeta[3])/36 - Zeta[5]/5) ),
*)
C20 -> ( N*nl*(-1541/648 - (37*Pi^2)/108 - (13*Zeta[3])/9) + 
	 N^2*(45275/2592 + (557*Pi^2)/216 - (39*Pi^4)/160 + (31*Zeta[3])/9) ),
C21 -> ( N*nl*(-46205/3888 - (673*Pi^2)/648 - (49*Pi^4)/360 - (91*Zeta[3])/27) + 
	 N^2*(1124291/15552 + (26383*Pi^2)/2592 + (727*Pi^4)/1440 + 
	   (125*Zeta[3])/54 + (5*Pi^2*Zeta[3])/18 - (211*Zeta[5])/2) ),
(*
C22 -> ( N*nl*(-1063589/23328 - (15481*Pi^2)/3888 - (1607*Pi^4)/4320 - 
	   (1711*Zeta[3])/162 - (28*Pi^2*Zeta[3])/27 - (361*Zeta[5])/15) + 
	 N^2*(23123195/93312 + (524455*Pi^2)/15552 + (6205*Pi^4)/3456 - 
	   (150767*Pi^6)/362880 + (37969*Zeta[3])/648 + (323*Pi^2*Zeta[3])/54 - 
	   (341*Zeta[3]^2)/18 + (403*Zeta[5])/15) ),
*)
C30 -> ( N*nl^2*(58883/26244 + (145*Pi^2)/243 + (221*Pi^4)/2430 + 
	   (1072*Zeta[3])/243) + N^3*(10907077/52488 + (15763067*Pi^2)/279936 - 
	   (116957*Pi^4)/38880 + (145051*Pi^6)/653184 - (15743*Zeta[3])/486 + 
	   (533*Pi^2*Zeta[3])/108 + (298*Zeta[3]^2)/9 - 357*Zeta[5]) + 
	 N^2*nl*(-6389497/104976 - (1160555*Pi^2)/69984 - (1337*Pi^4)/6480 - 
	   (296*Zeta[3])/9 - (77*Pi^2*Zeta[3])/108 + (602*Zeta[5])/9) + 
	 N^2*(-2*nfv - (5*nfv*Pi^2)/6 + (nfv*Pi^4)/180 - (7*nfv*Zeta[3])/3 + 
	   (40*nfv*Zeta[5])/3))
}
...
bt3 -> ((150473*N^4)/486 - (485513*N^3*nl)/1944 + (8654*N^2*nl^2)/243 +
 (130*N*nl^3)/243 + (44*N^4*Zeta[3])/9 - (20*N^3*nl*Zeta[3])/9 +
 (28*N^2*nl^2*Zeta[3])/3)
}

(*-------------------------------------------------------------------*)
(* Large-N limit in SU(N) gauge theory                               *)
(* N4 = (N^2-4)/N which appears in 3-loop massless quark form factors*)
(*                 Look at 1010.4478                                 *)
...
lnF1mv1lres = Collect[Expand[Normal[Series[lnF1mv1l /. subs1 /. subs2 /. subs3 /. subs4, {ep, 0, 3}]]], {ep, N, nl}];
...
lnF1mv2lres = Collect[Expand[Normal[Series[lnF1mv2l /. subs1 /. subs2 /. subs3 /. subs4, {ep, 0, 2}]]], {ep, N, nl}];
...
lnF1mv3lres = Collect[Expand[Normal[Series[lnF1mv3l /. subs1 /. subs2 /. subs3 /. subs4, {ep, 0, 1}]]], {ep, N, nl, nfv}];
...
lnF1mv4lres = Collect[Expand[Normal[Series[lnF1mv4l /. subs1 /. subs2 /. subs3 /. subs4, {ep, 0, 0}]]], {ep, N, nl, nfv}];
...
F1mv1l = ( C1 + (G1*LQm)/2 - (A1*LQm^2)/4 + (-G1/2 - K1/2 + (A1*LQm)/2)/ep + 
 ep*(-(G1*LQm^2)/4 + (A1*LQm^3)/12) + ep^2*((G1*LQm^3)/12 - (A1*LQm^4)/48) );
F1mv1lres = Collect[Expand[Normal[Series[F1mv1l /. subs1 /. subs2 /. subs3 /. subs4, {ep, 0, 2}]]], {ep, N, nl, nfv}];
...
F1mv2l = ( C2 + (C1*G1*LQm)/2 + (G2*LQm)/2 - (A2*LQm^2)/4 - (A1*C1*LQm^2)/4 - 
 ...
 (-(C1*G1)/2 - G2/4 - (C1*K1)/2 - K2/4 + (A2*LQm)/4 + (A1*C1*LQm)/2 - 
   ...
   (A1^2*LQm^5)/32) );
F1mv2lres = Collect[Expand[Normal[Series[F1mv2l /. subs1 /. subs2 /. subs3 /. subs4, {ep, 0, 1}]]], {ep, N, nl, nfv}];
...
F1mv3lres = Collect[Expand[Normal[Series[F1mv3l /. subs1 /. subs2 /. subs3 /. subs4, {ep, 0, 0}]]], {ep, N, nl, nfv}];
...
F1mv4lres = Collect[Expand[Normal[Series[F1mv4l /. subs1 /. subs2 /. subs3 /. subs4, {ep, 0, 0}]]], {ep, N, nl, nfv}];
...
Fqml1lres = Collect[Expand[Normal[Series[Fqml1l /. subs2 /. subs3 /. subs4, {ep, 0, 6}]]], {ep, N, nl, nfv}]; 
...
Fqml2l = ( A1^2/(8*ep^4) + (-(A1*bt0)/8 + (A1*G10)/4)/ep^3 + 
 ...
 (ep^4*(G13^2 + 2*G12*G14 + 2*G11*G15 - 2*bt0*G16 + 2*G10*G16 + 2*A1*G17 - 
    2*G25))/8 );
Fqml2lres = Collect[Expand[Normal[Series[Fqml2l /. subs2 /. subs3 /. subs4, {ep, 0, 4}]]], {ep, N, nl, nfv}]; 
...
Fqml3l = ( -A1^3/(48*ep^6) + (A1^2*bt0 - A1^2*G10)/(16*ep^5) + 
 ...
 (ep*(-3*G11^2*G12 + 6*bt0*G12^2 - 3*G10*G12^2 - 4*bt1*G13 + 12*bt0*G11*G13 - 
    ...
    8*G33))/48 );
Fqml3lres = Collect[Expand[Normal[Series[Fqml3l /. subs2 /. subs3 /. subs4, {ep, 0, 2}]]], {ep, N, nl, nfv}]; 
...
Fqml4l = ( A1^4/(384*ep^8) + (-(A1^3*bt0)/64 + (A1^3*G10)/96)/ep^7 + 
 ...
 (-18*A4 - 24*bt2*G10 + 16*A3*G11 - 96*bt0*bt1*G11 + 48*bt1*G10*G11 - 
  ...
  1152 );
Fqml4lres = Collect[Expand[Normal[Series[Fqml4l /. subs2 /. subs3 /. subs4, {ep, 0, 0}]]], {ep, N, nl, nfv}]; 
...
Fqml5lres = Collect[Expand[Normal[Series[Fqml5l /. subs2 /. subs3 /. subs4, {ep, 0, -3}]]], {ep, N, nl, nfv}]; 
